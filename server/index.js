...
const app = express();
app.use(helmet({ contentSecurityPolicy: false })); // Disable CSP for easier cross-origin communication
app.use(compression());
app.use(cors({ origin: '*', credentials: true })); // Explicitly allow all origins
